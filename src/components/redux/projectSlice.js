    ...
    projectData : [
        {
          ...
          languageUsed: ['React','React-router'],
        ...
        },
        {
          ...
          cardDetail: "This is my portfolio website built as part of Microverse's project to showcase my skills in HTML5, CSS3, and JAVASCRIPT.This is my portfolio website built as part of Microverse's project to showcase my skills in HTML5, CSS3, and JAVASCRIPT.This is my portfolio website built as part of Microverse's project to showcase my skills in HTML5, CSS3, and JAVASCRIPT.",
          languageUsed: ['HTML', 'CSS', 'JavaScript'],
          live_version: 'https://github.com/anshuman7negi/Anshuman-Portfolio',
          link_source: 'https://anshuman7negi.github.io/Anshuman-Portfolio/',
        },
      ],
      selectProject: null,
}
